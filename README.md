...
To change the [theme-color](https://developers.google.com/web/updates/2014/11/Support-for-theme-color-in-Chrome-39-for-Android), modify the `<meta name="theme-color" content="#ffffff">` tag in [index.html](./src/index.html)
